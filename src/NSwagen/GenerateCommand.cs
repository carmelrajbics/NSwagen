...
{
    [Description("Generates client code for the specified package or assembly. Provide either configuration file or package details.")]
    public class GenerateCommand : OaktonAsyncCommand<GenerateInput>
    {
        ...
        private static async Task<bool> ProcessGenerateRequest(GenerateInput input)
        {
        ...
        private static GeneratorConfiguration ParseConfiguration(GenerateInput input)
        {
